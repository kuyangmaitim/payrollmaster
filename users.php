                    ...
                    <div class="col-sm-12 mt-4">
                      <form>
                        <div class="form-row align-items-center">
                          ...
                          <div class="col-auto">
                            <button type="button" class="btn btn-primary pm-blue btn-lg bulk-update-dayoff-btn">Bulk Add/Update Dayoff</button>
                          </div>
                        </div>
                      </form>
                    </div>
...
<!-- modal for bulk update dayoff start -->

<button type="button" class="btn btn-primary pm-blue d-none" id="bulkUpdateDayoffModalTrigger" data-toggle="modal" data-target="#bulkUpdateDayoffModal">
  Launch demo modal
</button>

<div class="modal fade" id="bulkUpdateDayoffModal" tabindex="-1" role="dialog" aria-labelledby="bulkUpdateDayoffModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    <form action="#" id="bulkUpdateDayoffForm">
      <div class="modal-content">
        <div class="modal-header">
          <h5 class="modal-title text-white" id="bulkUpdateDayoffModalLabel">Bulk Add/Update Dayoff</h5>
          <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
          </button>
        </div>
        ...
        <div class="modal-footer">
          <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
          <button type="submit" class="btn btn-primary pm-blue">Save changes</button>
        </div>
      </div>
    </form>
  </div>
...
<!-- modal for bulk update dayoff end -->
